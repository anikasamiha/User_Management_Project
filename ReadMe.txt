...
They are: 
1. Mysql with mysql workbrench (We can use any database, but to run this project mysql is needed since I've mentioned it in the project settings file,
and mysql workbrench is the interface to look into the database manually). Keep the username 'root' & the password '17281728' as mentioned in the project settings file. 
...
Step-4//
Now, please copy the project from the  file I've sent named 'family_project' and paste it into the myEnv folder.
...
please open the mysql workbrench from your system. It opened in a tab in the browser. Complete necessary authentication with your password. Create a new database named 'FamilyDB'.
Now run the following commands serially:
'python manage.py migrate'
'python manage.py makemigrations family_register'
'python manage.py sqlmigrate family_register 0001'
'python manage.py migrate'
